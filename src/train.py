...
#     print(flag)
#     if flag:
#       state_dict_weights = torch.load('best_val_loss.pt',map_location=torch.device("cuda:0"))
#       model.load_state_dict(state_dict_weights)
#       state_dict_opt = torch.load('best_val_opt.pt',map_location=torch.device("cuda:0"))
